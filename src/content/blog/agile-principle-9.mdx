...
date: "2018-06-08"
author: "Mark Ewer"
slug: "agile-principle-9"
description: "Continuous attention to technical excellence and good design enhances agility."
tags: ["agile", "technical-excellence", "design", "solid-principles", "refactoring"]
image: "/images/blog/Jenga-is-not-engineering.png"
---
...
Technical excellence isn't just about writing "pretty" code or following academic principles. It's about:

- **Reducing future development costs** by making code easier to understand and modify
- **Minimizing bugs** through proper design patterns and testing
- **Enabling faster feature development** by building on solid foundations
- **Protecting the customer's investment** in the software system

When you invest in technical excellence up front, you're actually saving the customer money in the long run and making the development team more agile and responsive to changing requirements.
